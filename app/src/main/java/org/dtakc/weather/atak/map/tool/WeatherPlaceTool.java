package org.dtakc.weather.atak.map.tool;
...
public class WeatherPlaceTool extends Tool
    ...
    public boolean onToolBegin(Bundle extras) {
        ...
        String prompt = activeMode == Mode.WIND
                ? pluginContext.getString(org.dtakc.weather.atak.plugin.R.string.tool_prompt_wind)
                : pluginContext.getString(org.dtakc.weather.atak.plugin.R.string.tool_prompt_weather);
