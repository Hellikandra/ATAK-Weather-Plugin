package org.dtakc.weather.atak.data.geocoding;
...
import org.dtakc.weather.atak.util.CoordFormatter;
            ...
            public void onSuccess(String body) {
                try {
                    ...
                    if (label.trim().isEmpty()) {
                        label = String.format(java.util.Locale.US, "%.4f\u00b0N  %.4f\u00b0E", latitude, longitude);
                    }
