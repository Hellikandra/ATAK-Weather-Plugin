package org.dtakc.weather.atak.ui.view;
...
public class ParametersView {
    ...
    public void setDefinitionParams(
            String sourceId,
            List<org.dtakc.weather.atak.data.remote.WeatherSourceDefinition.ParamEntry> hourly,
            List<org.dtakc.weather.atak.data.remote.WeatherSourceDefinition.ParamEntry> daily,
            List<org.dtakc.weather.atak.data.remote.WeatherSourceDefinition.ParamEntry> current) {
    ...
    private void bindDefinitionSection(
            ...
            List<org.dtakc.weather.atak.data.remote.WeatherSourceDefinition.ParamEntry> entries,
        ...
        for (org.dtakc.weather.atak.data.remote.WeatherSourceDefinition.ParamEntry e : entries) {
        ...
        final List<org.dtakc.weather.atak.data.remote.WeatherSourceDefinition.ParamEntry>
                entriesCopy = entries;
        Button allBtn = root.findViewById(allBtnId);
        if (allBtn != null) allBtn.setOnClickListener(v -> {
            for (int i = 0; i < container.getChildCount(); i++) {
            ...
            for (org.dtakc.weather.atak.data.remote.WeatherSourceDefinition.ParamEntry e : entriesCopy)
