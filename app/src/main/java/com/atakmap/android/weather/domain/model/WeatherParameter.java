...
public enum WeatherParameter {
    ...
    HOURLY_RELATIVE_HUMIDITY_2M ("relative_humidity_2m",         "Relative Humidity (2 m)",              Category.HOURLY, true),
    HOURLY_DEWPOINT_2M          ("dew_point_2m",                 "Dewpoint (2 m)",                       Category.HOURLY, false),
    ...
    HOURLY_WEATHERCODE          ("weather_code",                 "Weather Code",                         Category.HOURLY, true),
    ...
    HOURLY_CLOUD_COVER          ("cloud_cover",                  "Cloud Cover Total",                    Category.HOURLY, false),
    HOURLY_CLOUD_COVER_LOW      ("cloud_cover_low",              "Cloud Cover Low",                      Category.HOURLY, false),
    HOURLY_CLOUD_COVER_MID      ("cloud_cover_mid",              "Cloud Cover Mid",                      Category.HOURLY, false),
    HOURLY_CLOUD_COVER_HIGH     ("cloud_cover_high",             "Cloud Cover High",                     Category.HOURLY, false),
    ...
    HOURLY_WINDSPEED_10M        ("wind_speed_10m",               "Wind Speed (10 m)",                    Category.HOURLY, true),
    HOURLY_WINDSPEED_80M        ("wind_speed_80m",               "Wind Speed (80 m)",                    Category.HOURLY, false),
    HOURLY_WINDSPEED_120M       ("wind_speed_120m",              "Wind Speed (120 m)",                   Category.HOURLY, false),
    HOURLY_WINDSPEED_180M       ("wind_speed_180m",              "Wind Speed (180 m)",                   Category.HOURLY, false),
    HOURLY_WINDDIRECTION_10M    ("wind_direction_10m",           "Wind Direction (10 m)",                Category.HOURLY, true),
    HOURLY_WINDDIRECTION_80M    ("wind_direction_80m",           "Wind Direction (80 m)",                Category.HOURLY, false),
    HOURLY_WINDDIRECTION_120M   ("wind_direction_120m",          "Wind Direction (120 m)",               Category.HOURLY, false),
    HOURLY_WINDDIRECTION_180M   ("wind_direction_180m",          "Wind Direction (180 m)",               Category.HOURLY, false),
    HOURLY_WINDGUSTS_10M        ("wind_gusts_10m",               "Wind Gusts (10 m)",                    Category.HOURLY, false),
    ...
    // ── DAILY ────────────────────────────────────────────────────────────────
    DAILY_WEATHERCODE           ("weather_code",                 "Weather Code",                         Category.DAILY, true),
    ...
    DAILY_WINDSPEED_10M_MAX     ("wind_speed_10m_max",           "Maximum Wind Speed (10 m)",            Category.DAILY, false),
    DAILY_WINDGUSTS_10M_MAX     ("wind_gusts_10m_max",           "Maximum Wind Gusts (10 m)",            Category.DAILY, false),
    DAILY_WINDDIRECTION_10M_DOM ("wind_direction_10m_dominant",  "Dominant Wind Direction (10 m)",       Category.DAILY, false),
    ...
    CURRENT_RELATIVE_HUMIDITY   ("relative_humidity_2m",         "Relative Humidity (2 m)",              Category.CURRENT, true),
    ...
    CURRENT_WEATHERCODE         ("weather_code",                 "Weather Code",                         Category.CURRENT, true),
    CURRENT_CLOUD_COVER         ("cloud_cover",                  "Cloud Cover Total",                    Category.CURRENT, false),
    ...
    CURRENT_WINDSPEED_10M       ("wind_speed_10m",               "Wind Speed (10 m)",                    Category.CURRENT, true),
    CURRENT_WINDDIRECTION_10M   ("wind_direction_10m",           "Wind Direction (10 m)",                Category.CURRENT, true),
    CURRENT_WINDGUSTS_10M       ("wind_gusts_10m",               "Wind Gusts (10 m)",                    Category.CURRENT, false);
